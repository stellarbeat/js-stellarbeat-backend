...
describe('test queries', () => {
    ...
    test('findInactiveAt', async () => {
        ...
        const measurementActive = new NodeMeasurementV2(time, nodePublicKeyStorageActive);
        measurementActive.isActive = true;
        const measurementOtherTime = new NodeMeasurementV2(new Date("12/12/2020"), nodePublicKeyStorageOtherTime);
