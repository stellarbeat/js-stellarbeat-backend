...
export default class SnapShotter {
    ...
    async updateOrCreateSnapShots(nodes: Node[], organizations: Organization[], time: Date):Promise<{
        ...
        let nodeSnapShots = await this.nodeSnapShotter.updateOrCreateSnapShots(nodes, time);
        ...
        let organizationSnapShots = await this.organizationSnapShotter.updateOrCreateSnapShots(organizations, time);
