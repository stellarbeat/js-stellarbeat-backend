...
export class init1559296078133 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "node_measurement" ("id" SERIAL NOT NULL, "time" TIMESTAMP WITH TIME ZONE NOT NULL, "publicKey" character varying(56) NOT NULL, "isActive" boolean NOT NULL, "isValidating" boolean NOT NULL, "isOverLoaded" boolean NOT NULL, CONSTRAINT "PK_884ef70233e29472514dc5fffe7" PRIMARY KEY ("id", "time"))`);
