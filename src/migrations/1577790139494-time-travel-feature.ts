...
export class timeTravelFeature1577790139494 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "node_measurement_v2" ("isActive" boolean NOT NULL, "isValidating" boolean NOT NULL, "isFullValidator" boolean NOT NULL, "isOverLoaded" boolean NOT NULL, "index" smallint NOT NULL, "time" TIMESTAMP WITH TIME ZONE NOT NULL, "nodePublicKeyStorageId" integer NOT NULL, CONSTRAINT "PK_a929bd2eeeab02f7553deab3782" PRIMARY KEY ("time", "nodePublicKeyStorageId"))`, undefined);
