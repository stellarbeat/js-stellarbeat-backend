...
export class timeTravelFeature1577790139494 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "crawl_v2" ("id" SERIAL NOT NULL, "time" TIMESTAMP WITH TIME ZONE NOT NULL, "ledgers" text NOT NULL DEFAULT '', "completed" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_2284a12c78d3a77e4509882e7ff" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_f29698257a330e17d2260b84b5" ON "crawl_v2" ("time", "completed") `, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "network_measurement_day" ("day" date NOT NULL, "nrOfActiveNodesSum" integer NOT NULL, "nrOfValidatorsSum" integer NOT NULL, "nrOfFullValidatorsSum" integer NOT NULL, "nrOfOrganizationsSum" integer NOT NULL, "transitiveQuorumSetSizeSum" integer NOT NULL, "hasQuorumIntersectionCount" smallint NOT NULL, "crawlCount" smallint NOT NULL, CONSTRAINT "PK_0ce528aca19df6bbfe148c6a38c" PRIMARY KEY ("day"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "node_measurement_v2" ("time" TIMESTAMP WITH TIME ZONE NOT NULL, "nodePublicKeyStorageId" integer NOT NULL, "isActive" boolean NOT NULL, "isValidating" boolean NOT NULL, "isFullValidator" boolean NOT NULL, "isOverLoaded" boolean NOT NULL, "index" smallint NOT NULL, CONSTRAINT "PK_6c64e42ec8a59f27ba5e4debd26" PRIMARY KEY ("time", "nodePublicKeyStorageId"))`, undefined);
        await queryRunner.query(`CREATE TABLE "node_snap_shot" ("id" SERIAL NOT NULL, "ip" text NOT NULL, "port" integer NOT NULL, "startDate" TIMESTAMP WITH TIME ZONE NOT NULL, "endDate" TIMESTAMP WITH TIME ZONE NOT NULL, "ipChange" boolean NOT NULL, "NodePublicKeyId" integer NOT NULL, "NodeDetailsId" integer, "QuorumSetId" integer, "GeoDataId" integer, "OrganizationIdStorageId" integer, CONSTRAINT "PK_ba6f2e2ed7527e6e2d6e2af7d8f" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "organization_measurement" ("time" TIMESTAMP WITH TIME ZONE NOT NULL, "organizationIdStorageId" integer NOT NULL, "isSubQuorumAvailable" boolean NOT NULL, "index" smallint NOT NULL, CONSTRAINT "PK_e4b2a03164c957c8d1afd202127" PRIMARY KEY ("time", "organizationIdStorageId"))`, undefined);
        await queryRunner.query(`CREATE TABLE "organization_measurement_day" ("day" date NOT NULL, "isSubQuorumAvailableCount" smallint NOT NULL DEFAULT 0, "indexSum" integer NOT NULL, "crawlCount" smallint NOT NULL DEFAULT 0, "organizationIdStorageId" integer NOT NULL, CONSTRAINT "PK_5b88732de93210a33834ecf20c6" PRIMARY KEY ("day", "organizationIdStorageId"))`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_f29698257a330e17d2260b84b5"`, undefined);
