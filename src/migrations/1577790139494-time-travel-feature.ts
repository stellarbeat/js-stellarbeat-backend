...
export class timeTravelFeature1577790139494 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "node_measurement_v2" ("time" TIMESTAMP WITH TIME ZONE NOT NULL, "isActive" boolean NOT NULL, "isValidating" boolean NOT NULL, "isFullValidator" boolean NOT NULL, "isOverLoaded" boolean NOT NULL, "index" smallint NOT NULL, "nodePublicKeyStorageId" integer NOT NULL, CONSTRAINT "PK_6c64e42ec8a59f27ba5e4debd26" PRIMARY KEY ("time", "nodePublicKeyStorageId"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "organization_measurement" ("time" TIMESTAMP WITH TIME ZONE NOT NULL, "isSubQuorumAvailable" boolean NOT NULL, "index" smallint NOT NULL, "organizationIdStorageId" integer NOT NULL, CONSTRAINT "PK_e4b2a03164c957c8d1afd202127" PRIMARY KEY ("time", "organizationIdStorageId"))`, undefined);
        await queryRunner.query(`CREATE TABLE "organization_measurement_day" ("day" TIMESTAMP WITH TIME ZONE NOT NULL, "isSubQuorumAvailableCount" smallint NOT NULL DEFAULT 0, "indexSum" integer NOT NULL, "crawlCount" smallint NOT NULL DEFAULT 0, "organizationIdStorageId" integer NOT NULL, CONSTRAINT "PK_5b88732de93210a33834ecf20c6" PRIMARY KEY ("day", "organizationIdStorageId"))`, undefined);
