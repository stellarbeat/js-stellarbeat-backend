...
export class timeTravelFeature1577790139494 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "node_measurement_day_v2" ("day" TIMESTAMP WITH TIME ZONE NOT NULL, "isActiveCount" smallint NOT NULL DEFAULT 0, "isValidatingCount" smallint NOT NULL DEFAULT 0, "isFullValidatorCount" smallint NOT NULL DEFAULT 0, "isOverloadedCount" smallint NOT NULL DEFAULT 0, "indexSum" integer NOT NULL, "nodeCrawlCount" smallint NOT NULL DEFAULT 0, "nodePublicKeyStorageId" integer NOT NULL, CONSTRAINT "PK_1aedd062771b591952c664b88c1" PRIMARY KEY ("day", "nodePublicKeyStorageId"))`, undefined);
