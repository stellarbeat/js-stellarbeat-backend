...
import OrganizationIdStorage from '../../../storage/entities/OrganizationIdStorage';
...
import NodeDetailsStorage from '../../../storage/entities/NodeDetailsStorage';
...
describe('multiple network updates', () => {
	...
	let networkUpdateProcessor: NetworkUpdatePersister;
